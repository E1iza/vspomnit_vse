    ...
    <div className="overflow-hidden bg-white py-24 sm:py-32 dark:bg-gray-900">
      <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
        <div className="max-w-4xl">
          ...
          <h1 className="mt-2 text-4xl font-semibold tracking-tight text-pretty text-cyan-600 sm:text-5xl dark:text-white">
        ...
        <section className="mt-20 grid grid-cols-1 lg:grid-cols-2 lg:gap-x-8 lg:gap-y-16">
          <div className="lg:pr-8">
            <h2 className="text-2xl font-semibold tracking-tight text-pretty text-gray-500 dark:text-white">
              Наша миссия
            </h2>
          ...
          <div className="max-lg:mt-16 lg:col-span-1">
            <p className="text-base/7 font-semibold text-gray-500 dark:text-gray-400">Путь проекта</p>
            ...
            <dl className="mt-6 grid grid-cols-1 gap-x-8 gap-y-4 sm:grid-cols-2">
              <div className="flex flex-col gap-y-2 border-b border-dotted border-gray-200 pb-4 dark:border-gray-700">
                ...
                <dd className="order-first text-6xl font-semibold tracking-tight text-emerald-700 dark:text-white">
