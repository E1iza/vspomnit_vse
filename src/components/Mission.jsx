    ...
    <div className="overflow-hidden bg-white py-24 sm:py-32 dark:bg-gray-900">
      <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
        <div className="max-w-4xl">
          <h1 className="mt-2 text-4xl font-semibold tracking-tight text-pretty text-cyan-700 dark:text-white">
            Экспедиции &laquo;Вспомнить всё&raquo; &mdash;
          </h1>
          <p className="mt-4 text-xl/8 text-balance text-gray-700 dark:text-gray-300">
            любовь к родине через познание и дело.
          </p>
        </div>
        <section className="mt-20 grid grid-cols-1 lg:grid-cols-2 lg:gap-x-8 lg:gap-y-16">
          <div className="lg:pr-8">
            ...
            <p className="mt-6 text-base/7 text-gray-600 dark:text-gray-400">
              Проект &laquo;Вспомнить всё&raquo; открывает подросткам и молодёжи живую историю своей страны. Наш формат предлагает личное соприкосновение с прошлым через деятельное участие и волонтёрские проекты.
            </p>
            <p className="mt-6 text-base/7 text-gray-600 dark:text-gray-400">
              Сохраняя память &mdash; ты преображаешь будущее. Стань частью общего дела вместе с нами!
            </p>
          </div>
